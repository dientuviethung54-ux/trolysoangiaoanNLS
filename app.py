...
<div class="main-header">
    ...
    <p>Tác giả: Phạm Anh Hùng - Trường Tiểu học Minh Quang - ĐT: 0989 403 068</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Phạm Anh Hùng - Trường Tiểu học Minh Quang - ĐT: 0989 403 068</div>", unsafe_allow_html=True)
